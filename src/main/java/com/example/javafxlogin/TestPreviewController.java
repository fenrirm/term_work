...
public class TestPreviewController implements Initializable {
    ...
    private final double SINGLE_CHOICE_PANE_HEIGHT = 329;
    private final double SINGLE_CHOICE_PANE_WIDTH = 1030;
    private final double MULTIPLE_CHOICE_PANE_HEIGHT = 350;
    private final double MULTIPLE_CHOICE_PANE_WIDTH = 1030;
    private final double WORD_PANE_HEIGHT = 300;
    private final double WORD_PANE_WIDTH =1030;
    ...
    private final double QUESTION_LABEL_WIDTH = 560;
    ...
    private final double RADIO_BUTTON_WIDTH = 386.0;
    ...
    private double IMAGE_VIEW_HEIGHT = 250.0;
    private double IMAGE_VIEW_WIDTH = 452.0;

    private double imageViewSingleChoiceQuestionLayoutX = 550.0;
    private double imageViewSingleChoiceQuestionLayoutY = 35.0;

    private double imageViewMultipleChoiceQuestionLayoutX = 550.0;
